...
public class Fooditems {
    ...
    public Fooditems(int tea, int sweetPorotta, int cake, int juice, int iceCream) {
        this.tea = tea;
    ...
    public static void main(String[] args) {
        ...
        Fooditems food = new Fooditems(10, 15, 20, 10, 25);
        Fooditems takeaway = new Fooditems(15, 20, 25, 15, 30);
        int y;
